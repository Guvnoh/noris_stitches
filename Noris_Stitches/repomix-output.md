...
server/src/tools/collections.ts
...
src/components/AdminEditProduct.tsx
...
````json
{
  ...
  "scripts": {
    ...
    "seed": "ts-node-dev --transpile-only src/scripts/seed-admin.ts",
    "build": "tsc",
...
## File: server/src/scripts/seed-admin.ts
````typescript
import mongoose from "mongoose";
import dotenv from "dotenv";
import bcrypt from "bcryptjs";
...
## File: server/src/tools/collections.ts
````typescript
...
## File: skills/browser-testing-with-devtools/SKILL.md
````markdown
---
...
## File: skills/ci-cd-and-automation/SKILL.md
````markdown
---
...
## File: skills/debugging-and-error-recovery/SKILL.md
````markdown
---
...
## File: skills/frontend-ui-engineering/SKILL.md
````markdown
---
...
## File: skills/idea-refine/examples.md
````markdown
...
## File: skills/idea-refine/frameworks.md
````markdown
...
## File: skills/idea-refine/refinement-criteria.md
````markdown
...
## File: skills/idea-refine/scripts/idea-refine.sh
````bash
#!/bin/bash
set -e
...
## File: skills/incremental-implementation/SKILL.md
````markdown
---
...
## File: skills/security-and-hardening/SKILL.md
````markdown
---
...
## File: skills/source-driven-development/SKILL.md
````markdown
---
...
## File: src/components/AdminEditProduct.tsx
````typescript
import { useState, useEffect } from "react";
...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 backdrop-blur-md border-b border-white/10 ${menuOpen ? "bg-black/40" : "bg-black/70"}`}>
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4 font-body">
        ...
        <div className="hidden md:flex items-center space-x-10 text-sm uppercase tracking-wider text-gray-200">
          <Link to="/" className="hover:text-yellow-400 transition no-underline text-gray-200">
            Home
          </Link>
          <a href="/#catalogue" className="hover:text-yellow-400 transition no-underline text-gray-200">
            Catalogue
          </a>
          <Link to="/about" className="hover:text-yellow-400 transition no-underline text-gray-200">
            About
          </Link>
          <Link to="/contact" className="hover:text-yellow-400 transition no-underline text-gray-200">
            Contact
          </Link>
        </div>
        ...
        {/* Mobile Hamburger */}
        <button
          className="md:hidden flex flex-col items-center justify-center w-8 h-8 z-50 relative gap-[7px]"
          onClick={() => setMenuOpen(!menuOpen)}
          aria-label="Toggle menu"
        >
          <span
            className={`block w-6 h-[2px] bg-white rounded-sm transition-all duration-300 ease-out origin-center ${
              menuOpen ? "rotate-45 translate-y-[9px]" : ""
            }`}
          />
          <span
            className={`block w-6 h-[2px] bg-white rounded-sm transition-all duration-300 ease-out ${
      ...
      <>
        ...
        {/* Panel */}
        <div
          className={`fixed top-0 right-0 h-full w-72 z-40 p-8 transition-transform duration-300 ${
        ...
        >
          ...
          <div className="mt-24 flex flex-col space-y-2">
            <Link
              to="/"
              onClick={close}
              className="text-white hover:text-yellow-400 transition uppercase tracking-wider text-sm no-underline"
            >
              Home
            </Link>
            <a
